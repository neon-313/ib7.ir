...
def jalali_converter_only_date(time):
    ...
    maif_date = item.split('/')
    main_date = item
    if len(maif_date[1]) == 1 :
        main_date= f"{maif_date[0]}/0{maif_date[1]}/{maif_date[2]}"
    if len(maif_date[2]) == 1:
        main_date= f"{maif_date[0]}/{maif_date[1]}/0{maif_date[2]}"
    if len(maif_date[2]) == 1 and len(maif_date[1]) == 1 :
        main_date= f"{maif_date[0]}/0{maif_date[1]}/0{maif_date[2]}"

    return persian_numbers_converter(main_date)
