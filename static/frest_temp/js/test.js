      ...
      columnDefs: [
        {
          ...
          render: function (data, type, full, meta) {
            ...
            var $status = {
              1: { title: 'ع©ظ†ظˆظ†غŒ', class: 'bg-label-primary' },
              2: { title: 'ط­ط±ظپظ‡â€Œط§غŒ', class: ' bg-label-success' },
              3: { title: 'ط±ط¯ ط´ط¯ظ‡', class: ' bg-label-danger' },
              4: { title: 'ط§ط³طھط¹ظپط§ ط¯ط§ط¯ظ‡', class: ' bg-label-warning' },
              5: { title: 'ط¯ط±ط®ظˆط§ط³طھ ط¯ط§ط¯ظ‡', class: ' bg-label-info' }
            };
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="dropdown-item">ط¬ط²ط¦غŒط§طھ</a>' +
              '<a href="javascript:;" class="dropdown-item">ط¨ط§غŒع¯ط§ظ†غŒ</a>' +
              '<div class="dropdown-divider"></div>' +
              '<a href="javascript:;" class="dropdown-item text-danger delete-record">ط­ط°ظپ</a>' +
              '</div>' +
              '</div>' +
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            ...
            if ($user_img) {
              // For Avatar image
              var $output =
                '<img src="' + assetsPath + 'img/avatars/' + $user_img + '" alt="ط¢ظˆط§طھط§ط±" class="rounded-circle">';
            } else {
              // For Avatar badge
      ...
      responsive: {
        details: {
          display: $.fn.dataTable.Responsive.display.modal({
            header: function (row) {
              var data = row.data();
              return 'ط¬ط²ط¦غŒط§طھ ' + data['full_name'];
            }
          }),
          type: 'column',
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              ...
              '<a href="javascript:;" class="dropdown-item">ط¨ط§غŒع¯ط§ظ†غŒ</a>' +
              '<div class="dropdown-divider"></div>' +
              '<a href="javascript:;" class="dropdown-item text-danger delete-record"></i>ط­ط°ظپ</a>' +
              '</div>' +
              '</div>' +
              '<a href="javascript:;" class="item-edit text-body"><i class="bx bxs-edit"></i></a>'
            );
