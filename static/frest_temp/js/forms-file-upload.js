...
<div class="dz-details">
  ...
  const dropzoneMulti = new Dropzone('#dropzone-basic', options);
dropzoneMulti.on('success', function (file, xhr) {
    console.log('Sending file...', file);
    // formData.append('file', file);
    
    $.ajax({
        url: '/InstallMent/upload_documents',  // Replace with your actual upload URL
        method: 'GET',
        processData: false,
        contentType: false,
        data: file,
        success: function (response) {
            ...
            // Perform any necessary actions after a successful upload
        },
