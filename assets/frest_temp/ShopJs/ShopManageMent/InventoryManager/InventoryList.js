...
$(function () {
    ...
    if (dt_scrollable_table.length) {
        var requestgetdataurl = $("#InventoryManagerUrl").val();
...

                {
                    ...
                    render: function (data, type, full, meta) {
                        ...
                        return (
                            ...
                            `<a  href="/ShopManageMent/CreateOrEditInv/${full['id']}" class="btn btn-sm btn-icon dropdown-toggle hide-arrow" ><i class='bx bx-cog' ></i></a>` 
