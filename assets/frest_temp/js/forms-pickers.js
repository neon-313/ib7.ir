...
(function () {
  ...
  const flatpickrDate = document.querySelector('#flatpickr-date'),
    flatpickrDate_1 = document.querySelector('#flatpickr-date_1'),
    flatpickrDate_2 = document.querySelector('#flatpickr-date_2'),
    flatpickrDate_3 = document.querySelector('#flatpickr-date_3'),
    flatpickrDate_4 = document.querySelector('#flatpickr-date_4'),
    flatpickrDate_5 = document.querySelector('#flatpickr-date_5'),
    flatpickrDate_6 = document.querySelector('#flatpickr-date_6'),
    flatpickrDate_7 = document.querySelector('#flatpickr-date_7'),
    flatpickrDate_8 = document.querySelector('#flatpickr-date_8'),
    flatpickrDate_9 = document.querySelector('#flatpickr-date_9'),
    flatpickrDate_10 = document.querySelector('#flatpickr-date_10'),
    flatpickrDate_11 = document.querySelector('#flatpickr-date_11'),
